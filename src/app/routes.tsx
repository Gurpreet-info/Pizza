...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: 'popularpizza-menu', Component: MenuPage },
      { path: 'popularpizza-menu/category/:categorySlug', Component: MenuPage },
      { path: 'popularpizza-menu/item/:id', Component: MenuItemPage },
      { path: 'cart', Component: CartPage },
      { path: 'checkout', Component: CheckoutPage },
      { path: 'order-confirmation/:orderId', Component: OrderConfirmationPage },
      { path: 'locations', Component: LocationsPage },
      { path: 'popularpizza-coupons', Component: CouponsPage },
      { path: 'popularpizza-offers', Component: OffersPage },
